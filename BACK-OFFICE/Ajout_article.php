...
include("header.php");
?>
<form method= "post" action="Formulaire articles.php">
           <p> 
            ...
            <p> 
              ...
              <input type="date" name= "Date de publication" id="Date de publication" placeholder="XXXX-XX-XX" style="width: 250px;" style="height: 30px;"/>
            </p>
            <p> 
